...
|----------|-------|
| **Run ID** | `run115` |
| **Timestamp** | 2025-09-28T21:52:54.319295 |
...
![Degree Analysis](visualizations/run115_degree_analysis.png)
...
*Local neighborhood connectivity and transitivity*
...
*Shortest paths and network diameter measurements*
...
| **Largest Scc Average Shortest Path Length** | 2.24 | 25.0% BFS sampling | ✅ computed |
| **Largest Scc Global Efficiency** | 0.4622 | 25.0% BFS sampling | ✅ computed |
